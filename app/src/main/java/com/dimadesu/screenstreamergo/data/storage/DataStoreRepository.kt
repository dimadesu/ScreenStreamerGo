package com.dimadesu.screenstreamergo.data.storage
...
import com.dimadesu.screenstreamergo.models.FileExtension
import com.dimadesu.screenstreamergo.utils.appendIfNotEndsWith
import com.dimadesu.screenstreamergo.utils.createVideoContentUri
...
class DataStoreRepository(
     ...
     */
    val regulatorModeFlow: Flow<com.dimadesu.screenstreamergo.bitrate.RegulatorMode> = dataStore.data.map { preferences ->
        ...
        when (stored) {
            context.getString(R.string.srt_server_moblin_regulator_mode_value_slow) -> com.dimadesu.screenstreamergo.bitrate.RegulatorMode.MOBLIN_SLOW
            context.getString(R.string.srt_server_moblin_regulator_mode_value_belabox) -> com.dimadesu.screenstreamergo.bitrate.RegulatorMode.BELABOX
            else -> com.dimadesu.screenstreamergo.bitrate.RegulatorMode.BELABOX
        }
    }.distinctUntilChanged()
