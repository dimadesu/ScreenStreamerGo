 ...
 */
package com.dimadesu.screenstreamergo.services.utils
...
class NotificationUtils(
    ...
    fun createNotification(
        ...
        val openIntent = Intent(service, MainActivity::class.java).apply {
            action = "com.dimadesu.screenstreamergo.ACTION_OPEN_FROM_NOTIFICATION"
    ...
    fun createServiceNotification(
        ...
        openPending: PendingIntent?
            ...
            if (exitPending != null) addAction(iconResourceId, service.getString(com.dimadesu.screenstreamergo.R.string.service_notification_action_exit), exitPending)
