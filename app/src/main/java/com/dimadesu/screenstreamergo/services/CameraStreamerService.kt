package com.dimadesu.screenstreamergo.services
...
import com.dimadesu.screenstreamergo.services.utils.NotificationUtils
import com.dimadesu.screenstreamergo.ui.main.MainActivity
...
import com.dimadesu.screenstreamergo.audio.BluetoothAudioSource
import com.dimadesu.screenstreamergo.audio.ScoOrchestrator
...
class CameraStreamerService : StreamerService<ISingleStreamer>(
    ...
    companion object {
        ...
        const val ACTION_STOP_STREAM = "com.dimadesu.screenstreamergo.action.STOP_STREAM"
        const val ACTION_START_STREAM = "com.dimadesu.screenstreamergo.action.START_STREAM"
        const val ACTION_TOGGLE_MUTE = "com.dimadesu.screenstreamergo.action.TOGGLE_MUTE"
        const val ACTION_EXIT_APP = "com.dimadesu.screenstreamergo.action.EXIT_APP"
        const val ACTION_OPEN_FROM_NOTIFICATION = "com.dimadesu.screenstreamergo.ACTION_OPEN_FROM_NOTIFICATION"
    ...
    private val audioPassthroughManager by lazy { 
        com.dimadesu.screenstreamergo.audio.AudioPassthroughManager(applicationContext)
    }
    ...
    private val bluetoothAudioManager by lazy { 
        com.dimadesu.screenstreamergo.audio.BluetoothAudioManager(this, serviceScope, bluetoothConnectPermissionRequest) 
    }
    ...
    override fun onCreate() {
        ...
        com.dimadesu.screenstreamergo.audio.BluetoothAudioConfig.setEnabled(false)
        com.dimadesu.screenstreamergo.audio.BluetoothAudioConfig.setPreferredDevice(null)
        ...
        serviceScope.launch {
            storageRepository.audioConfigFlow
                ...
                .collect { audioConfig ->
                    if (audioConfig != null) {
                        val passthroughConfig = com.dimadesu.screenstreamergo.audio.AudioPassthroughConfig(
    ...
    private fun isUsingRtmpSource(): Boolean {
        ...
        return videoSource is com.dimadesu.screenstreamergo.rtmp.video.RTMPVideoSource
    }
    ...
    private fun acquireNetworkWakeLock() {
        if (networkWakeLock == null) {
            networkWakeLock = powerManager.newWakeLock(
                PowerManager.PARTIAL_WAKE_LOCK,
                "ScreenStreamerGo::NetworkUpload"
            ).apply {
                acquire() // No timeout - held until manually released
        ...
        try {
            ...
            if (descriptor.type.sinkType == MediaSinkType.SRT) {
                ...
                if (bitrateRegulatorConfig != null) {
                    try {
                        val mode = try { storageRepository.regulatorModeFlow.first() } catch (_: Exception) { com.dimadesu.screenstreamergo.bitrate.RegulatorMode.MOBLIN_FAST }
            ...
            passthroughRestartJob = serviceScope.launch(Dispatchers.Default) {
                try {
                    ...
                    val preferredDevice = if (scoSuccess) {
                        com.dimadesu.screenstreamergo.audio.BluetoothAudioConfig.getPreferredDevice()
                    } else {
                        null
                    }
    ...
    fun startAudioPassthrough() {
        serviceScope.launch(Dispatchers.Default) {
            try {
                ...
                val btEnabled = com.dimadesu.screenstreamergo.audio.BluetoothAudioConfig.isEnabled()
