...
import com.dimadesu.screenstreamergo.databinding.MainActivityBinding
import com.dimadesu.screenstreamergo.ui.settings.SettingsActivity
import com.dimadesu.screenstreamergo.ui.help.FaqHelpActivity
import com.dimadesu.screenstreamergo.ui.help.KnownIssuesActivity
import com.dimadesu.screenstreamergo.ui.help.RtmpHelpActivity
import com.dimadesu.screenstreamergo.ui.help.SrtHelpActivity
import com.dimadesu.screenstreamergo.ui.help.UvcHelpActivity
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onNewIntent(intent: Intent) {
        ...
        if (action == "com.dimadesu.screenstreamergo.ACTION_OPEN_FROM_NOTIFICATION") {
        ...
        } else if (action == "com.dimadesu.screenstreamergo.action.EXIT_APP") {
            // Exit requested via notification: properly stop service and finish activity
            try {
                // Stop service gracefully
                val stopIntent = Intent(this, com.dimadesu.screenstreamergo.services.CameraStreamerService::class.java)
