...
import com.dimadesu.screenstreamergo.player.SrtDataSourceFactory
import com.dimadesu.screenstreamergo.player.TsOnlyExtractorFactory
        ...
        try {
            ...
            if (projection != null && android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.Q) {
                try {
                    ...
                    streamer.setAudioSource(com.dimadesu.screenstreamergo.audio.ConditionalAudioSourceFactory())
            ...
            while (attemptCount < maxAttempts && isActive) {
                ...
                try {
                    ...
                    val videoSourceUrl = try {
                        ...
                        application.getString(com.dimadesu.screenstreamergo.R.string.rtmp_source_default_url)
                    }
